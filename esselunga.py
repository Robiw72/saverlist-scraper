...
class EsselungaScraper(ScraperBase):
    ...
    def scrape(self):
        urls = [
            ...
            "https://www.volantinoonline.it/esselunga",
            "https://www.volantinoonline.it/esselunga/volantini",
        ]
    ...
    def _extract_name(self, item, text):
        for tag in ["h2", "h3", "h4", "strong", ".title", ".name", ".product-title"]:
    ...
    def _extract_date(self, item, text):
        patterns = [
            ...
            r'dal\s+\d{1,2}[/-]\d{1,2}\s+al\s+(\d{1,2})[/-](\d{1,2})',
        ]
        for p in patterns:
    ...
    def _guess_category(self, name):
        ...
        cats = {
            ...
            "Latte e Formaggi": ["latte", "formaggio", "yogurt", "burro", "mozzarella", "parmigiano", "ricotta"],
            "Pasta e Riso": ["pasta", "spaghetti", "penne", "riso", "farina", "pane", "cracker", "fette"],
            "Bevande": ["acqua", "bibita", "succo", "vino", "birra", "caffè", "caffe", "tè", "te", "cioccolata"],
            "Detersivi e Pulizia": ["detersivo", "ammorbidente", "candeggina", "pulizia", "lavastoviglie", "lavatrice"],
            "Cura Persona": ["shampoo", "crema", "dentifricio", "deodorante", "sapone"],
            "Dolci e Snack": ["biscotto", "cioccolato", "snack", "merendina", "torta", "dolce", "gelato", "caramella"],
